...
TARGET_GLOBAL_CFLAGS += -mfpu=neon-vfpv4 -mfloat-abi=softfp -Wno-error=unused-parameter
TARGET_GLOBAL_CPPFLAGS += -mfpu=neon-vfpv4 -mfloat-abi=softfp -Wno-error=unused-parameter
...
TARGET_KERNEL_SOURCE := kernel/lge/gprojx
